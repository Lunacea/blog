...
<ol class="index-list m-0 grid list-none border-t border-ink p-0" aria-label={label}>
  {#each entries as entry (entry.slug)}
    <li
      class="group relative isolate border-b border-rule before:absolute before:inset-x-0 before:-bottom-px before:h-px before:origin-left before:scale-x-0 before:bg-ink before:transition-[scale] before:duration-(--motion-duration-base) before:ease-enter hover:before:scale-x-100 focus-within:before:scale-x-100 motion-off:before:duration-(--motion-duration-immediate)"
    >
      <!--
