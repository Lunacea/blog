...
<ContentDetailView
  ...
  kind={metadata.type}
  class={cn(
    "[&_.article-header]:grid [&_.article-header]:min-h-0 [&_.article-header]:grid-cols-1 [&_.article-header]:content-start [&_.article-header]:gap-3 [&_.article-header]:pb-12 [&_.article-header>*]:w-[min(100%,var(--prose-width))] read:max-read-wide:[&_.article-header>*]:w-[min(var(--prose-width),100%-var(--space-12)-var(--space-8))] [&_h1]:m-0 [&_h1]:max-w-[24ch] [&_h1]:text-balance [&_h1]:font-interface [&_h1]:text-(length:--text-h1) [&_h1]:font-strong [&_h1]:leading-tight [&_h1]:tracking-(--tracking-heading) [&_.article-flags]:flex [&_.article-flags]:flex-wrap [&_.article-flags]:items-center [&_.article-flags]:gap-2 [&_.article-flags]:leading-none [&_.detail-flags]:flex [&_.detail-flags]:flex-wrap [&_.detail-flags]:items-center [&_.detail-flags]:justify-between [&_.detail-flags]:gap-2 [&_.lead]:m-0 [&_.lead]:max-w-prose [&_.lead]:leading-copy [&_.tag-list]:m-0 [&_.tag-list]:flex [&_.tag-list]:list-none [&_.tag-list]:flex-wrap [&_.tag-list]:items-center [&_.tag-list]:gap-x-(--space-3) [&_.tag-list]:gap-y-(--space-1) [&_.tag-list]:p-0 [&_.tag-list]:leading-none",
