...
it("weather conditions normalize to the shared visual vocabulary", () => {
...
it("development weather overrides accept only visual states", () => {
...
it("reported rain and snow are never reinterpreted", () => {
...
it("a shower is rarer over a clear sky than over cloud, and always passing", () => {
...
it("showers follow the month: wetter in summer, snow only in the cold months", () => {
...
it("the same bucket always gives the same sky", () => {
